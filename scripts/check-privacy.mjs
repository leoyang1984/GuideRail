...
const reviewedPngAssets = new Set([
  'public/icons/icon-16.png', 'public/icons/icon-32.png', 'public/icons/icon-48.png', 'public/icons/icon-128.png', 'docs/images/plugin-update-source.png',
]);
function scan(name, buffer) {
  ...
  if (buffer.includes(0)) {
    ...
    if (reviewedPngAssets.has(name) && png) return;
    console.error(`${name}: binary requires manual review`); findings++; return;
  }
