...
const roots = new Set(['README.md', 'DEVELOPMENT.md', 'LICENSE', 'CONTRIBUTING.md', '.gitignore', 'package.json', 'package-lock.json', 'tsconfig.json', 'vite.config.ts', 'src', 'public', 'scripts', 'tests', 'docs', 'packages', 'CHROMEWEBSTORE.md', 'store-assets']);
