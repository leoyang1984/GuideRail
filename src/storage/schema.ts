...
export type Command =
  | { type: 'saveReply'; capture: Capture; preferredTitle?: string }
...
export type Capture = Pick<MessageSource, 'conversationId' | 'messageId' | 'role' | 'pageUrl' | 'text' | 'html'> & { markdown?: string; images?: { data: string }[] };
