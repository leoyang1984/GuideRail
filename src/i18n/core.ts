...
export const dictionaries = {
  en: {
    ...
    obsidianDesc: 'Saved via local Companion; please keep Obsidian running.',
    ...
    companionKeepRunningTip: '💡 Note: Obsidian mode requires the desktop app to be running. Please keep Obsidian open in the background while saving notes.',
    companionDisconnectedTitle: 'Unable to Connect to Obsidian',
    currentBoundVault: 'Paired Vault: {name}',
    companionTroubleshootTitle: '⚠️ Obsidian desktop app is not running',
    companionTroubleshootStep1: '1. Open the Obsidian desktop app on your computer;',
    companionTroubleshootStep2: '2. Ensure GuideRail Companion is enabled in Settings -> Community plugins.',
    btnRetryConnection: '🔄 Recheck Connection',
    reconfigureCompanion: 'Need to re-pair or change port?',
  ...
  zh: {
    ...
    obsidianVault: 'Obsidian Vault',
    localFolder: '保存文件夹',
    obsidianDesc: '通过本机 Companion 保存，需保持 Obsidian 处于运行状态。',
    ...
    companionKeepRunningTip: '💡 使用提示：Obsidian 模式依赖本地桌面端运行。日常使用请保持 Obsidian 在后台开启，若关闭将暂时无法同步笔记。',
    companionDisconnectedTitle: '无法连接到 Obsidian',
    currentBoundVault: '已绑定笔记库：{name}',
    companionTroubleshootTitle: '⚠️ 检测到 Obsidian 桌面端未运行',
    companionTroubleshootStep1: '1. 请在电脑上启动 Obsidian 桌面端；',
    companionTroubleshootStep2: '2. 确保在“设置 -> 第三方插件”中已启用 GuideRail Companion。',
    btnRetryConnection: '🔄 重新检测连接',
    reconfigureCompanion: '需要重新配对或切换其他端口？',
